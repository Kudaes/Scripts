...
namespace DInvoke.DynamicInvoke
{
    ...
    public static class Win32
    {
        ...
        public static class Delegates
        {
            ...
            [UnmanagedFunctionPointer(CallingConvention.StdCall)]
            public delegate IntPtr VirtualAlloc(IntPtr baseAddress, UIntPtr size, Data.Win32.Kernel32.MemoryAllocationFlags allocationType,
                                                 Data.Win32.Kernel32.MemoryProtectionFlags protection);
