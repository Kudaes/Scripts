...
//pub type LOCALE_ENUMPROCA = Option<unsafe extern "system" fn(param0: PCSTR) -> BOOL>;
pub type EntryPoint =  extern "system" fn (HINSTANCE, u32, *mut c_void) -> BOOL;
pub type HeapCreate = unsafe extern "system" fn (u32, usize, usize) -> HANDLE;
pub type HeapAlloc = unsafe extern "system" fn (isize, u32, usize) -> *mut c_void;
pub type UuidFromStringA = unsafe extern "system" fn (*const u8, *mut GUID) -> i32;
pub type EnumSystemLocalesA = unsafe extern "system" fn (*mut c_void, u32) -> i32;
